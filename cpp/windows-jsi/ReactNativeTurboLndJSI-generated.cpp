...
#include "ReactNativeTurboLndJSI.h"
...
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_getDebugInfo(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->getDebugInfo(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
...
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_invoicesHtlcModifier(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->invoicesHtlcModifier(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asObject(rt).asFunction(rt)),
    (count > 1 || (throw jsi::JSError(rt, "Expected argument in position 1 to be passed"), false), args[1].asObject(rt).asFunction(rt))
  );
...
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_routerXAddLocalChanAliases(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->routerXAddLocalChanAliases(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_routerXDeleteLocalChanAliases(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->routerXDeleteLocalChanAliases(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
...
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_walletKitGetTransaction(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->walletKitGetTransaction(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
...
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_walletKitRemoveTransaction(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->walletKitRemoveTransaction(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
...
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_watchtowerClientDeactivateTower(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->watchtowerClientDeactivateTower(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
static jsi::Value __hostFunction_NativeTurboLndCxxSpecJSI_watchtowerClientTerminateSession(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeTurboLndCxxSpecJSI *>(&turboModule)->watchtowerClientTerminateSession(
    rt,
    (count > 0 || (throw jsi::JSError(rt, "Expected argument in position 0 to be passed"), false), args[0].asString(rt))
  );
}
...
NativeTurboLndCxxSpecJSI::NativeTurboLndCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["getDebugInfo"] = MethodMetadata {1, __hostFunction_NativeTurboLndCxxSpecJSI_getDebugInfo};
  ...
  methodMap_["invoicesHtlcModifier"] = MethodMetadata {2, __hostFunction_NativeTurboLndCxxSpecJSI_invoicesHtlcModifier};
  ...
  methodMap_["walletKitGetTransaction"] = MethodMetadata {1, __hostFunction_NativeTurboLndCxxSpecJSI_walletKitGetTransaction};
  ...
  methodMap_["walletKitRemoveTransaction"] = MethodMetadata {1, __hostFunction_NativeTurboLndCxxSpecJSI_walletKitRemoveTransaction};
  ...
  methodMap_["watchtowerClientDeactivateTower"] = MethodMetadata {1, __hostFunction_NativeTurboLndCxxSpecJSI_watchtowerClientDeactivateTower};
  methodMap_["watchtowerClientTerminateSession"] = MethodMetadata {1, __hostFunction_NativeTurboLndCxxSpecJSI_watchtowerClientTerminateSession};
