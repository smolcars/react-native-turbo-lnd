...
extern void sendOnionMessage(char* data, int length, CCallback callback);
extern void subscribeOnionMessages(char* data, int length, CRecvStream rStream);
...
extern void routerDeleteForwardingHistory(char* data, int length, CCallback callback);
...
extern void signerMuSig2RegisterCombinedNonce(char* data, int length, CCallback callback);
extern void signerMuSig2GetCombinedNonce(char* data, int length, CCallback callback);
