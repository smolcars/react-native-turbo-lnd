 ...
 */
const GetTransactionRequestSchema = exports.GetTransactionRequestSchema = /*@__PURE__*/
 ...
 */
const RemoveTransactionResponseSchema = exports.RemoveTransactionResponseSchema = /*@__PURE__*/
...
(0, _codegenv.messageDesc)(file_walletrpc_walletkit, 45, 0);
 ...
 */
const PsbtCoinSelectSchema = exports.PsbtCoinSelectSchema = /*@__PURE__*/
...
(0, _codegenv.messageDesc)(file_walletrpc_walletkit, 56);
...
(0, _codegenv.messageDesc)(file_walletrpc_walletkit, 57);
...
(0, _codegenv.messageDesc)(file_walletrpc_walletkit, 58);
...
let WitnessType = exports.WitnessType = /*#__PURE__*/function (WitnessType) {
   ...
   */
  WitnessType[WitnessType["TAPROOT_LOCAL_COMMIT_SPEND"] = 23] = "TAPROOT_LOCAL_COMMIT_SPEND";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_REMOTE_COMMIT_SPEND"] = 24] = "TAPROOT_REMOTE_COMMIT_SPEND";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_ANCHOR_SWEEP_SPEND"] = 25] = "TAPROOT_ANCHOR_SWEEP_SPEND";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_OFFERED_TIMEOUT_SECOND_LEVEL"] = 26] = "TAPROOT_HTLC_OFFERED_TIMEOUT_SECOND_LEVEL";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_ACCEPTED_SUCCESS_SECOND_LEVEL"] = 27] = "TAPROOT_HTLC_ACCEPTED_SUCCESS_SECOND_LEVEL";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_SECOND_LEVEL_REVOKE"] = 28] = "TAPROOT_HTLC_SECOND_LEVEL_REVOKE";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_ACCEPTED_REVOKE"] = 29] = "TAPROOT_HTLC_ACCEPTED_REVOKE";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_OFFERED_REVOKE"] = 30] = "TAPROOT_HTLC_OFFERED_REVOKE";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_OFFERED_REMOTE_TIMEOUT"] = 31] = "TAPROOT_HTLC_OFFERED_REMOTE_TIMEOUT";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_LOCAL_OFFERED_TIMEOUT"] = 32] = "TAPROOT_HTLC_LOCAL_OFFERED_TIMEOUT";
  /**
   *
   * A witness that allows us to sweep an HTLC that was offered to us by the
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_ACCEPTED_REMOTE_SUCCESS"] = 33] = "TAPROOT_HTLC_ACCEPTED_REMOTE_SUCCESS";
  /**
   *
   ...
   */
  WitnessType[WitnessType["TAPROOT_HTLC_ACCEPTED_LOCAL_SUCCESS"] = 34] = "TAPROOT_HTLC_ACCEPTED_LOCAL_SUCCESS";
  /**
   *
   * A witness that allows us to sweep the settled output of a malicious
   ...
   */
  WitnessType[WitnessType["TAPROOT_COMMITMENT_REVOKE"] = 35] = "TAPROOT_COMMITMENT_REVOKE";
  return WitnessType;
}({});
/**
