...
export interface Spec extends TurboModule {
   ...
   *
   */
  getDebugInfo(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  deleteCanceledInvoice(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  invoicesHtlcModifier(onResponse: OnResponseCallback, onError: OnErrorCallback): WriteableStream;
   ...
   *
   */
  routerXAddLocalChanAliases(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  routerXDeleteLocalChanAliases(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  routerXFindBaseLocalChanAlias(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  walletKitGetTransaction(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  walletKitRemoveTransaction(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  walletKitBumpForceCloseFee(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  watchtowerClientDeactivateTower(data: ProtobufBase64): Promise<ProtobufBase64>;
   ...
   *
   */
  watchtowerClientTerminateSession(data: ProtobufBase64): Promise<ProtobufBase64>;
